...
import { addItem, cartItemMinus, removeItem } from '../redux/Slices/cartSlice';
  ...
  return (
    <div className='cart__item'>
      ...
      <div className='cart__item-remove'>
        <div onClick={onClickRemoveAll} className='button button--outline button--circle'>
          <svg
            width='10'
            height='10'
            viewBox='0 0 10 10'
